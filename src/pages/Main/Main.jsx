...
export default function Main() {
    ...
    return<>
        <div className={style.container}>
            ...
            <div data-aos="zoom-out" style={{fontFamily:`Russo One`}} className={'mt-3 max-w-[300px] w-full h-auto p-2 text-start text-[18px] uppercase bg-white rounded-xl min-[950px]:hidden'}>
